...
const Form = () => {
  ...
  const defaultValues = {
    ...
    stepTwo: {
      firstName: "Test",
      lastName: "Test",
      email: "xorisot359@paseacuba.com",
      country: "Peru",
      city: "Lima",
      password: "usuario123",
      passwordConfirmation: "usuario123",
    ...
    stepThree: {
      ...
      os: ["windows", "other"],
      fbUsername: "xorisot359@paseacuba.com",
      fbPassword: "julio1234",
      code2FA: "43211234432112344321123443211234",
    },
    stepFour: {
      paymentMethod: "paypal",
      paypalEmail: "xorisot359@paseacuba.com",
      paypalEmailConfirmation: "xorisot359@paseacuba.com",
      referral: "",
